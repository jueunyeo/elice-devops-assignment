...
- External CI should only update image tags in:
  - `aws/kubernetes/services/<service>/values-dev.yaml`
  - `aws/kubernetes/services/<service>/values-stage.yaml`
  - `aws/kubernetes/services/<service>/values-prod.yaml`
